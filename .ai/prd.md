...
| US-010 | Save Reviewed Cards        | As a user, after reviewing all AI candidates, I want to save the accepted/edited ones to my deck.       | 1. A "Save" button is present on the "Create flashcards" page.<br>2. If there are unreviewed AI candidates, a confirmation modal appears warning that they will be discarded.<br>3. Upon confirmation, clicking this button persists all "Accepted" and "Edited" cards to the database under the user's account.<br>4. Unreviewed AI candidates are counted as "deleted" in generation metrics.<br>5. The review list is then cleared. |
