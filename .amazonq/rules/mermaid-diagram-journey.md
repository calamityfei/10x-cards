...
You are a UX specialist whose task is to create a Mermaid diagram to visualize the user journey for the login and registration module. The diagram should be created in the following file: `.ai/diagrams/auth-user-journey-diagram.md`.
...
<destination>
.ai/diagrams/auth-user-journey-diagram.md
</destination>
...
3. Follow these Mermaid syntax rules:
   ...
   - For parallel states, use correct syntax:
     ...
     fork_state --> SendingEmail
     fork_state --> DatabaseUpdate
     SendingEmail --> join_state
...
4. Avoid these common mistakes:
   ...
   - Unclosed nested states (missing closing brace)
