...
Create `.env` file with required Supabase credentials (based on the snippet below or `.env.example` in project root). If it's already created and have mentioned in below snippet keys, skip this step.
