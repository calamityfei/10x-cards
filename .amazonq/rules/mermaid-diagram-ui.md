...
You are an experienced software architect whose task is to create a Mermaid diagram to visualize the architecture of Astro pages and React components for the login and registration module. The diagram should be created in the following file: `.ai/diagrams/auth-ui-components-diagram.md`.
...
<destination>
.ai/diagrams/auth-ui-components-diagram.md
</destination>
